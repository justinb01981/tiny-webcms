...
"var tableJournalSortAlpha = true;\n"
...
"}\n"
"function sort() {\n"
"    tableJournalSortAlpha = !tableJournalSortAlpha;\n"
"    tableJournalClear();\n"
"    var i = 0;\n"
"    var j = tableJournalSortAlpha ? 1 : -1;\n"
"    var b = tableJournalSortAlpha ? 0 : fileList.length-1;\n"
"    var count = 0;\n"
"    for(i = b; count < fileList.length; i += j) {\n"
"        count += 1;\n"
